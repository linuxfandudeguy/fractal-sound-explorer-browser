...
let isInteracting = false;  // Tracks if the user is interacting with the canvas
let fractalImage;
let fractalConstant;
...
function handleStart(event) {
  ...
  isInteracting = true;
  const { x, y } = getInteractionPosition(event);
...
// Get the interaction position relative to the canvas (works for both mouse and touch)
